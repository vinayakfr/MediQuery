  ...
  return (
    <div className="flex-1 h-full flex flex-col pr-2 pb-2">
      ...
      {/* <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        <div className="glass-panel rounded-3xl p-6 relative overflow-hidden group cursor-pointer">
          <div className="absolute top-0 right-0 w-32 h-32 rounded-full blur-3xl group-hover:bg-green-400/60 transition-all duration-700"></div>
          <div className="text-sm font-medium text-gray-600 mb-2">
            Total Convos
          </div>
          <div className="flex items-end gap-4 mb-4">
            <span className="text-6xl font-light tracking-tighter text-gray-800">
              350
            </span>
            <span className="flex items-center gap-1 text-xs font-semibold px-2 py-1 bg-green-200/50 text-green-700 rounded-lg mb-2">
              <ArrowUpRight size={14} /> 204%
            </span>
          </div>
          <button className="text-sm font-medium flex items-center gap-2 text-gray-700 hover:text-black">
            See Report &rarr;
          </button>
        </div>

        <div className="glass-panel-dark-dark rounded-3xl p-6 relative overflow-hidden group cursor-pointer">
          <div className="absolute top-0 right-0 w-32 h-32 rounded-full blur-3xl group-hover:bg-red-700/60 transition-all duration-700" />
          ...
          <div className="flex items-end gap-4 mb-4">
            ...
            <span className="flex items-center gap-1 text-xs font-semibold px-2 py-1 bg-red-200/70 text-red-700 rounded-lg mb-2">
              Urgent
            </span>
          </div>
        </div>
            ...
            <div className="w-full h-full flex flex-col gap-2 items-start justify-start text-gray-400 font-light">
              <div className="flex gap-2 w-full items-center justify-center">
                <input
                  ...
                  className="w-full glass-panel h-14 rounded-2xl px-4"
